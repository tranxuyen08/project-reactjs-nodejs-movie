...
const { MovieProductsController, upload } = require("../controllers/movie.controller");

router.get('/search', MovieProductsController.handleSearchTitle);
router.post("/add-movie", upload, MovieProductsController.handleAddMovie);// router.get('/', MovieProductsController.handleGetMovie);
